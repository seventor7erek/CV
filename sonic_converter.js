 ...
 * @returns {Uint8Array}
 */
export function convertMp3ToWav(mp3_data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(mp3_data, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.convertMp3ToWav(retptr, ptr0, len0);
 ...
 * @returns {Uint8Array}
 */
export function convertMp3ToWavWithDepth(mp3_data, bit_depth) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(mp3_data, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.convertMp3ToWavWithDepth(retptr, ptr0, len0, bit_depth);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
 ...
 * @returns {string}
 */
export function getMp3Info(mp3_data) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(mp3_data, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.getMp3Info(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('sonic_converter_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
